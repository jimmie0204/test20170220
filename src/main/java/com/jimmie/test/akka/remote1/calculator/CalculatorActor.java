...
public class CalculatorActor extends UntypedActor {
  ...
  public void preStart() throws Exception {
    super.preStart();
    System.out.println("CalculatorActor创建 context().self()==="+context().self());
    System.out.println("CalculatorActor context().self().path()==="+context().self().path());
    System.out.println("CalculatorActor context().parent()==="+context().parent());
    System.out.println("CalculatorActor context().parent().path()==="+context().parent().path());
    System.out.println("CalculatorActor context().self().path().parent()==="+context().self().path().parent());
  }
